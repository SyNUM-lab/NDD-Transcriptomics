...
# Select non-in vitro datasets
topList <- topList[metaData$ID[metaData$System != "Primary"]]

# Alternative: select in vitro datasets
topList <- topList[metaData$ID[metaData$System == "Primary"]]
...
save(results_both, results_down, results_up,
     file = "8. Imprinting/PermResults_invitro.RData")
