...
load("4. GSEA/GSEA_GO/GSEAresults_GO_CC.RData")
...
save(reducedTerms, file = "5. overallMeta/GSEA/reducedTerms_CC.RData")
#==============================================================================#

load("5. OverallMeta/GSEA/reducedTerms_CC.RData")
...
clusterDF <- data.frame(ID = names(cutree(model, k = 6)),
                        Cluster = cutree(model, k = 6))
save(terms_ordered, clusterDF, file = "5. overallMeta/GSEA/terms_ordered_CC.RData")
...
plotDF$Cluster[plotDF$Cluster == 3] <- "C"
plotDF$Cluster[plotDF$Cluster == 4] <- "D"
plotDF$Cluster[plotDF$Cluster == 5] <- "A"
plotDF$Cluster[plotDF$Cluster == 6] <- " "
...
# Save plot
ggsave(gp, file = "5. overallMeta/GSEA/GSEAplot_all_CC.png", width = 10, height = 5)
...
# Save legend
ggsave(legend, file = "5. overallMeta/GSEA/GSEAplot_all_CC_legend.png", width = 4, height = 4)
